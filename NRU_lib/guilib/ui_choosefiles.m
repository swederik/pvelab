function [files,result,filter_out,hout] = ui_choosefiles(path, filter, header, hin)
%
% [files,result,filter_out,hout] = ...
%      ui_choosefiles(path, filter, header, hin)
%   Program for choosing a list of files
%
%   files - list of files, returned in a cell array
%   result - (1 or 0) success
%   filter_out - filter used
%   hout - handle to window used
% 
%   path - initial path
%   filter - filter for files to choose eg. '*.img'
%   header - header for window
%   hin - handle to window to use
%  
%   DL, 1998
%   CS, 150800, help added
%
