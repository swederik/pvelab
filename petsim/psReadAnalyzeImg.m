function [img,hdr]=psReadAnalyzeImg(name,dim,pre,lim,no,scale,offset,fileformat)
%  Reads one or more images in img file
%
%    img=ReadAnalyzeImg(name,dim,pre,lim,no[,scale,offset[,fileformat]])
